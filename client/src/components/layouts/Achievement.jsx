...
const Achievement = ({ setAlert, submitAchievement }) => {
  ...
  const onSubmit = async (e) => {
    ...
    const success = submitAchievement(
      formInput,
      `${process.env.REACT_APP_CLIENT_URL}/awards/${res1.data}`,
  ...
  return (
    <React.Fragment>
      <div className="form-container">
        <h1 className="hero-head">Achievements</h1>
        <form className="form" onSubmit={(e) => onSubmit(e)}>
          <div style={{ paddingBottom: "1em", color: "red" }}>
            <strong>
              Note: If you are an ALUMNI and you have achieved any patent /
              reward / recognition, then you can fill out this form to let the
              institute know of your achievement.
            </strong>
          </div>
          ...
          <div className="form-group">
            <label>
              Your photo receiving the award / Any Passport photo (Supported
          ...
          <div className="form-group">
            <label>
              Certificate / Proof of Achievement (Supported formats: .pdf, .png,
              .jpg, .jpeg)
            </label>
            <input
              type="file"
